...
mod vs;
use crate::renderer::vs::Shader as VertexShader;

mod fs;
use crate::renderer::fs::Shader as FragmentShader;
...
impl Renderer {
    ...
    pub fn setup(mut self, event_loop: &mut EventLoop<()>) -> Self {
    ...
    pub fn handle_events(&mut self, event_loop: &mut EventLoop<()>) -> bool {
        let mut exit = false;
    ...
    fn create_window(&mut self, event_loop: &mut EventLoop<()>) {
